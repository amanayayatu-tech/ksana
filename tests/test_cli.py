...
def write_mock_inputs(data_dir):
    ...
    (rec_root / "f_partner").mkdir(parents=True)
    (rec_root / "w_partner").mkdir(parents=True)
    (rec_root / "g_partner").mkdir(parents=True)
    ...
    fixtures = [
        ("f_partner", make_f_partner("long")),
        ("w_partner", make_w_partner("watch")),
        ("g_partner", make_g_partner("watch")),
    ]
