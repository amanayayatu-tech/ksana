...
def trans(value: Any) -> str:
    ...
    mapping = {
        ...
        "human_review_for_trial_candidate": "人工复核小仓/纸面跟踪候选",
        "human_review_for_conviction_candidate": "人工复核高信号候选",
        "paper_track": "纸面跟踪",
        "human_ic_review": "人工投委复核",
        "deep_research": "深度研究",
        "discard_or_wait_for_new_signal": "丢弃或等待新信号",
